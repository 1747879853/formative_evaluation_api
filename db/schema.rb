...
ActiveRecord::Schema.define(version: 2019_08_29_071819) do
  ...
  create_table "students", force: :cascade do |t|
    ...
    t.string "email", default: "email@email", null: false
    ...
    t.string "birthday", default: "0"
    t.string "nation", default: "0"
  end
