...
ActiveRecord::Schema.define(version: 2018_11_01_010333) do
  ...
  create_table "approval20180810154446s", force: :cascade do |t|
    t.string "field0"
    t.integer "approval_id"
    t.string "approval_name"
    t.integer "user_id"
  ...
  create_table "approval20180810155115s", force: :cascade do |t|
    t.string "field0"
    t.integer "approval_id"
    t.string "approval_name"
    t.integer "user_id"
  ...
  create_table "approval20180810161302s", force: :cascade do |t|
    t.string "field0"
    t.integer "approval_id"
    t.string "approval_name"
    t.integer "user_id"
  ...
  create_table "approval20180810161608s", force: :cascade do |t|
    t.string "field0"
    t.integer "approval_id"
    t.string "approval_name"
    t.integer "user_id"
  ...
  create_table "approval20181024093245s", force: :cascade do |t|
    t.integer "approval_id"
    t.string "approval_name"
    t.integer "user_id"
    t.string "no"
  ...
  create_table "approval20181025083645s", force: :cascade do |t|
    t.string "field0"
    t.string "field1"
    t.integer "approval_id"
    t.string "approval_name"
  ...
  create_table "approval_detail20181024093245s", force: :cascade do |t|
    t.string "field0"
    t.string "field1"
    t.string "field2"
    t.string "field3"
    ...
    t.string "field5"
    t.string "field6"
    t.integer "approval20181024093245_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "work_logs", force: :cascade do |t|
    ...
    t.integer "order_id"
    t.integer "user_id"
    t.decimal "passed_number", precision: 8, scale: 2
